...
class TestUserAuthentication(TestCase):
    ...
    def test_check_http_authorization_with_invalid_basic_type(self):
        ...
        self.assertEqual(UNAUTHORIZED, self.ua.check_http_authorization(
    ...
    def test_check_puppetdb_user_with_correct_data(self, node, resources):
        ...
        self.assertEqual('User[test.user]',
                         str(self.ua.check_puppetdb_user('test.user')))
    ...
    def test_is_authenticated_without_data(self):
        self.assertEqual(UNAUTHORIZED,
                         self.ua.is_authenticated(self.request).status_code)
